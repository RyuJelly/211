			...
			<div class="panel-body">
				<table class="table table-striped table-bordered table-hover">
					...
					<c:forEach items="${list}" var="noticeBoard">
						<tr>
							<td><c:out value="${noticeBoard.notice_id}" /></td>
							<td><a href='/noticeBoard/get?notice_id=<c:out value="${noticeBoard.notice_id}"/>'>
								<c:out value="${noticeBoard.notice_title}"/></a></td>

							<%-- 
							 <td>
							 	<a class='move' href='<c:out value="${noticeBoard.notice_id}"/>'>
									<c:out value="${noticeBoard.notice_title}" />
								 </a>
							 </td>
 							--%>
 							
							<td><c:out value="${noticeBoard.notice_writer}" /></td>
							<td><fmt:formatDate pattern="yyyy-MM-dd"
									value="${noticeBoard.notice_date}" /></td>
						</tr>
					</c:forEach>
				</table>
