		...
		<div class="main-slide">
			...
			<div id="slider-div" class="content-center">
				<c:forEach items="${list }" var="product" end="4">
					<a href="/product/get?product_id=${product.product_id }">
						<div class="slider-img">						
							<img src="resources/assets/img/building-1246260_1280.jpg" alt="img${product.product_id }">						
						</div>
					</a>
				</c:forEach>
			</div>
				...
				<c:forEach items="${list}" var="product">
					<a href="product.html" class="list-box">
						<div class="list-box__img">							
							<img src="C:\upload\<fmt:formatDate pattern="yyyy\MM\dd"
											value="${product.create_date}" />\<c:out value="${product.image}" />"
								alt="상품이미지">
							<!-- <img src="C:\\upload\"
								alt="상품이미지"> -->
						</div>
